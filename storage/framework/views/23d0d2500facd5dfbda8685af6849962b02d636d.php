...
<head>
    ...
    <title><?php echo e(config('app.name', 'precog')); ?></title>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #560084;">
        <div class="container-fluid">
            <a class="navbar-brand" href="#" style="color: #fff;"><?php echo e(config('app.name', 'Precog')); ?></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <?php if(auth()->guard()->guest()): ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('register')); ?>" style="color: #fff;">Register</a>
                        </li>
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" style="color: #fff;">Logout</a>
...
<?php /**PATH D:\xampp\htdocs\Second-Hand Car Price Project\Preccog_System\resources\views/layouts/app.blade.php ENDPATH**/ ?>